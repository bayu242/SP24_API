...
const lastProcessedTags = new Map();
/**
 * LOGIKA WEBSOCKET
 */
io.on("connection", (socket) => {
    ...
    socket.on("check-pairing-code", (code) => {
    ...
    socket.on("android-send-tag", (data) => {
...
const startServer = async () => {
    try {
        ...
        server.listen(PORT, () => {
            ...
            console.log(`⚡ WebSocket Bridge Active: Ready for Android-to-Web NFC pairing`);
        });
    }
    catch (error) {
